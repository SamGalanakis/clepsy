...
def _current_window(now: Optional[datetime] = None) -> tuple[datetime, datetime]:
...
def aggregate_window(start_iso: str | None = None, end_iso: str | None = None) -> None:
    ...
    def _map_source_event(row) -> E.AggregationInputEvent | None:
        ...
        if etype == "desktop_screenshot_ocr":
        ...
        elif etype == "desktop_screenshot_vlm":
